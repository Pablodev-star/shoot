...
export const ABILITY_KEY = {
  ...
  A: PALETTE.algae,
  V: PALETTE.lichen,
  // The hollow: dead ground, grave timber, and the light nobody lit. Same
  // characters the biome art uses in src/art/env-kit.js.
  '*': PALETTE.pall,
  '(': PALETTE.pallMid,
  ')': PALETTE.gloam,
  '[': PALETTE.gloamDark,
...
export const ABILITY_ICONS = {
   ...
   */
  /** Grave's Grip — a hand out of the ground, closed on a wrist. */
  gravesGrip: [
    '................',
    '.....k....k.....',
    '....k*k..k*k....',
  ...
  /** Marrow Drain — a cup of bone with a thread of something warm over it. */
  marrowDrain: [
    '................',
    '.......k........',
    '......kRk.......',
  ...
  /** Death Mark — a board driven into the ground with your name cut into it. */
  deathMark: [
    '................',
    '....kkkkkkkk....',
    '...k}}}}}}}}k...',
  ...
  /** Cold Sweat — a face going through the one expression this world causes. */
  coldSweat: [
    '................',
    '.....kkkkkk.....',
    '....k******k....',
  ...
  /** The Gallows — a frame of grey timber, and the bell hung off the beam. */
  gallows: [
    'kkkkkkkkkkkkkk..',
    'k}}}}}}}}}}}}k..',
    'k}{{{{{{{{{{}k..',
